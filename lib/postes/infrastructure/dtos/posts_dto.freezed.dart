...
class _$PostsDtoImpl extends _PostsDto {
  const _$PostsDtoImpl({this.id, required this.title, required this.body})
      : super._();
  ...
  @override
  String toString() {
    return 'PostsDto(id: $id, title: $title, body: $body)';
  }
...
abstract class _PostsDto extends PostsDto {
  const factory _PostsDto(
      {final int? id,
      required final String title,
      required final String body}) = _$PostsDtoImpl;
